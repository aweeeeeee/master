    ...
    <div class="row my-account-container">
      <div class="col-lg-4">
        ...
        <div class="col-lg-8 my-account-form">
            ...
            <div class="d-flex justify-content-between join-step-next p-1 mb-3 border-bot6 pb-3">
                    <button class="btn btn-primary bg-333 btn-no-border px-4"><i class="arrow-left"></i> BACK</button>
            </div>
            <div class="border-bot6 pb-3 mb-4">
                <h3>Voice Selection</h3>
                <div><b>SELECT VOICE OPTIONS</b></div>
                <div>Please select Your Voice Options and nominated Voice Talent.</div>
            </div>
            <div class="row mb-4 get-started-column m-r-l font13-5">
                <div class="col-sm-auto">
                    <div class="c0066ff"><b>RANDOM VOICE</b></div>
                    <div>We Select <b>Random</b> Voices <br>for <b>ALL</b> Your Videos</div>
                </div>
                <div class="col-sm-4 mx-auto border-left-right-ccc">
                    <div class="mx-auto">
                        <div class="c0066ff font-weight-bold">SAME VOICE</div>
                        <div>You Select the <b>Same</b> <br>Voice for <b>ALL</b> Your Videos</div>
                    </div>
                </div>
                <div class="col-sm text-justify">
                    <div class="c0066ff font-weight-bold">ROTATED VOICE</div>
                    <div>You Select <b>Many</b> Voices and <br>they are <b>Rotated</b> for Your Videos</div>
                </div>
            </div>
            ...
            <div class="border-bot6 pb-3 my-4">
                <h3>Music Selection</h3>
                <b>SELECT MUSIC OPTIONS</b>
                <div>Please select Your Music Options and nominated Music Tracks.</div>
            </div>
            <div class="row mb-2 get-started-column m-r-l font13-5">
                <div class="col-sm-auto">
                    <div class="c0066ff"><b>RANDOM MUSIC</b></div>
                    <div>We Select <b>Random</b> Music <br>for <b>ALL</b> Your Videos</div>
                </div>
                <div class="col-sm-auto mx-auto border-left-right-ccc px-4">
                    <div class="mx-auto">
                        <div class="c0066ff"><b>ONE MUSIC TRACK</b></div>
                        <div>You Select the <b>Same</b> <br>Music for <b>ALL</b> Your Videos</div>
                    </div>
                </div>
                <div class="col-sm text-justify">
                        <div class="c0066ff"><b>ROTATED MUSIC TRACKS</b></div>
                        <div>You Select <b>Many</b> Music Tracks and <br>they are <b>Rotated</b> for Your Videos</div>
                </div>
            </div>
         ...
         <div class="d-flex my-4 join-step-next">
                  ...
                  <div class="ml-auto">
                      <button type="submit" class="btn btn-primary font-weight-bold join-step-next">
                               SAVE : Next Step 5 <i class="arrow-right"></i>
                      </button>
                  </div>
         </div>
        </div>
